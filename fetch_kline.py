...
def _to_ts_code(code: str) -> str:
    # 北交所: 920xxx, 83xxxx, 87xxxx, 43xxxx
    if code.zfill(6)[:2] in ("92", "83", "87") or code.zfill(6)[:3] == "43":
...
def main():
    ...
    parser.add_argument("--exclude-gem", action='store_true', help="排除创业板/科创板/北交所（默认全市场）")
    ...
    parser.add_argument("--out", default="./fetch_kline/stock_kline", help="输出目录")
    parser.add_argument("--workers", type=int, default=3, help="并发线程数")
    args = parser.parse_args()

    # ---------- Token 处理 ---------- #
    if args.datasource == "tushare":
        ts_token = "c2a96ee78a444f422063ba90ed4460a8f252f3fd136ea893f6c310ae"  # 在这里补充token
